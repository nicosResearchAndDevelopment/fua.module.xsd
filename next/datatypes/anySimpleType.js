...
class anySimpleType extends model.anyType {
    ...
    static from(value) {
        ...
        if (value instanceof anySimpleType) throw new Error(`expected ${this.id} but got ${value.type.id}`);
        const instance = new this();
        if (util.isObject(value) && util.isString(value['@value'])) instance.value = value['@value'];
        else if (util.isString(value)) instance.value = value;
        return instance;
    }
