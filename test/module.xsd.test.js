...
describe('module.xsd', function () {
  ...
  describe('xsd.types', function () {
    ...
    test('integer', function () {
      ...
      // expect(xsd_integer('-123456789012345678901234567890')).toBe(-123456789012345678901234567890); // FIXME: RangeError
    ...
    test('long', function () {
      ...
      // expect(xsd_long('-9223372036854775808')).toBe(-9223372036854775808); // FIXME: RangeError
      expect(xsd_long('0')).toBe(0);
      expect(xsd_long('-0000000000000000000005')).toBe(-5);
      // expect(xsd_long('9223372036854775807')).toBe(9223372036854775807); // FIXME: RangeError
    ...
    test('negativeInteger', function () {
      ...
      // expect(xsd_negativeInteger('-123456789012345678901234567890')).toBe(-123456789012345678901234567890); // FIXME: RangeError
    ...
    test('nonNegativeInteger', function () {
      ...
      // expect(xsd_nonNegativeInteger('+123456789012345678901234567890')).toBe(123456789012345678901234567890); // FIXME: RangeError
    ...
    test('nonPositiveInteger', function () {
      ...
      // expect(xsd_nonPositiveInteger('-123456789012345678901234567890')).toBe(-123456789012345678901234567890); // FIXME: RangeError
    ...
    test('positiveInteger', function () {
      ...
      // expect(xsd_positiveInteger('123456789012345678901234567890')).toBe(123456789012345678901234567890); // FIXME: RangeError
    ...
    test('unsignedLong', function () {
      ...
      // expect(xsd_unsignedLong('18446744073709551615')).toBe(18446744073709551615); // FIXME: RangeError
